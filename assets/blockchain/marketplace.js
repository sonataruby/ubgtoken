SmartApp = (function (SmartApp, $, window) {
    ...
    var login_wallet;
    let TokenAddress = "0x20d53f340b5de606aae50e78364357f83853f8bc";//0xca7b9de520737b938faaf4dbfc8de45ef5516931
    ...
    SmartApp.Marketplace.buyTickets = async (id, songaymua) => {
        ...
        let data = await MarketplaceContact.buyTickets(id, songaymua).send({from : login_wallet, gas:1200000}).then(async (data) =>{
            console.log(data);
        });
    ...
    SmartApp.Marketplace.setTokenMoney = async (address) => {
        await MarketplaceContact.setCurentcy(address).send({from : login_wallet}).then(async (data) =>{
            console.log(data);
        });
    };
